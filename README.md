#  Путь в ML/MLOps с нуля
> Мой личный дневник и техническое портфолио за год интенсивного обучения (2026-2027).
...
*   **Практика:** Минимум 4 полноценных pet-проекта (Classic ML, MLOps, CV, RAG/LLM).
*   **Карьера:** Подготовиться к собеседованиям и выйти на стажировку в Яндекс/Сбер к лету 2027.
*   **Инструментарий:** Освоить Docker, Git, FastAPI, MLflow и облачные вычисления.

## Дорожная карта (Progress)
- [x] **P0: Онбординг** (Дни 1-2) - Настройка окружения, Гитхаб, цели.
- [ ] **P1: Python & Математика** (Дни 3-14)
- [ ] **P2: Алгоритмы и SQL** (Дни 15-30)
- [ ] **P3: Классический Machine Learning** (Дни 31-44)
- [ ] ... остальные фазы будут добавляться по мере прохождения.

## Стек технологий
*   **Языки:** Python (NumPy, Pandas, Scikit-learn)
*   **Инструменты:** VS Code, Git, Jupyter Notebook
*   **Обучение:** Яндекс.Хендбук, Kaggle, Stepik, ML Zoomcamp
...
---
*Обучение начато: 10 июля 2026 г.*
